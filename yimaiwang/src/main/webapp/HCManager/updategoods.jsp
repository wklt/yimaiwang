...
<div >
    <div>
        <img src="img/2.png" style="width: 15px; height:15px"><b>修改商品</b>
    </div>

    <div id="a3">
        <form action="updategoods2.do?id=${eproduct.id }" method="post" enctype="multipart/form-data">
            <table cellspacing="0" cellpadding="0" style="width: 800px">
                <tr style="height: 30px;">
                    <td class="q2">商品名称：</td>
                    <td><input type="text" name="name" value="${eproduct.name }" /></td>
                </tr>
                <tr style="height: 30px;">
                    <td class="q2">描述：</td>
                    <td><input type="text" name="description" value="${eproduct.description }"/></td>
                </tr>
                <tr style="height: 30px;">
                    <td class="q2">所属分类：</td>
                    <td>
                ...
                <tr style="height: 30px;">
                    <td class="q2">商品价格：</td>
                    <td><input type="text" name="price" value="${eproduct.price }"/></td>
                </tr>
                <tr style="height: 30px;">
                    <td class="q2">库存：</td>
                    <td><input type="text" name="stock" value="${eproduct.stock }"/></td>
                </tr>
                <tr style="height: 30px;">
                    <td class="q2">商品图片：</td>
